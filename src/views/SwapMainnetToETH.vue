  ...
  methods: {
    ...
    async sendSwap() {
      ...
      try {
        ...
        await this.$msgbox({
          title: 'Warning',
          message: `<p style="margin-bottom: 30px;">Are you certain you wish to swap "${customAmount}" GNY from the Mainnet to your ERC20 compatible wallet "${custumEthAddress}"? There will be a fee of ${customFee} GNY for the swap.</p>
           <p style="margin-bottom: 30px;">If the current ETH gas fees are comparable to the ${customFee} GNY fee, your GNY ERC20 tokens should arrive in your wallet within 10 minutes.</p>
